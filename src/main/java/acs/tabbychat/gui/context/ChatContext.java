...
public abstract class ChatContext extends GuiButton {
    ...
    protected void drawIcon() {
        ...
        worldRenderer.addVertexWithUV(x1, y1, this.zLevel, 0, 0);
        worldRenderer.addVertexWithUV(x1, y2, this.zLevel, 0, 1);
        worldRenderer.addVertexWithUV(x2, y2, this.zLevel, 1, 1);
        worldRenderer.addVertexWithUV(x2, y1, this.zLevel, 1, 0);
        tess.draw();
    }
